...
<script type="text/javascript">
	...
	<body>
		...
		<div id="main-content">
			...
			$arr=cargarformi2($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
			$html=checkformi2($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
			...
			if($arr["total"]==0){
				...
				$arr["movimiento"][0]="";
				$arr["declarante"][0]="";
				$arr["tipo_institucion"][0]="";
				$arr["otra_institucion"][0]="";
				$arr["nombre_inst"][0]="";
				$arr["rfc_inst"][0]="";
				$arr["puesto_id"][0]="";
				$arr["puesto_descr"][0]="";
			...
			<script type="text/javascript">
		  		$(document).ready(function(){
		    		...
		    		$('#tipo_institucion option[value="'+'<?php echo $arr["tipo_institucion"][0] ?>'+'"]').attr('selected', 'selected');
			...
			<div class="content" id="content">
				...
				<form id="form-content-i">
					<div class="subtitle">2. ¿PARTICIPA EN LA TOMA DE DECISIONES DE ALGUNA DE ESTAS INSTITUCIONES?<br><p class="subtitle2">(HASTA LOS 2 ULTIMOS AÑOS)</p>
					</div>
					...
					<div class="forms-container ningun_registro">
						...
						<div class="form-div-3">
							<label>Tipo de Institución:</label><span class="asterisk">*</span>
							<select id="tipo_institucion" name="tipo_institucion" required>
								<?php lista_valores("Tipo_Institucion"); ?>
							</select>
						</div>
						<div class="form-div-3" id="div_institucion" style="display:none;">
							<label>Especifique:</label>
							<input type="text" name="otra_institucion" id="otra_institucion" maxlength="50" value="<?php echo $arr['otra_institucion'][0]; ?>">
						</div>
					</div>
					<div class="forms-container ningun_registro">
						<div class="form-div-3">
							<label>Nombre de la institución:</label><span class="asterisk">*</span>
							<input type="text" placeholder="Institución" name="nombre_inst" id="nombre_inst" maxlength="100" value="<?php echo $arr['nombre_inst'][0]; ?>" required>
						</div>
						<div class="form-div-3">
							<label>RFC:</label><span class="asterisk">*</span>
							<input type="text" placeholder="RFC" name="rfc_inst" id="rfc_inst" minlength="12" maxlength="13" onkeypress="valida(event,'clave')" onpaste="valida(event,'clave')" value="<?php echo $arr['rfc_inst'][0]; ?>" required>
							<div class="aviso_pendientes" id="aviso_rfc_inst"></div>
						</div>
						<div class="form-div-3">
							<label>Puesto / Rol:</label><span class="asterisk">*</span>
							<input type="text" placeholder="Puesto" name="puesto_descr" id="puesto_descr" maxlength="100" value="<?php echo $arr['puesto_descr'][0]; ?>" required>
						</div>
					</div>
					<div class="forms-container ningun_registro">
						<div class="form-div-3">
							<label>Fecha de inicio de participación:</label><span class="asterisk">*</span>
							<input type="date" name="fecha_inicio" id="fecha_inicio" class="fecha" style="width:80%; display: block; border-radius:5px; background-color: #F2F2F2; font-family:contenidos;" max="<?php echo date('Y-m-d'); ?>" value="<?php echo $arr['fecha_inicio'][0]; ?>" required>
						</div>
					</div>
					<div class="forms-container ningun_registro">
						<div class="form-div-3">
...
<!-- 							<input type="text" placeholder="Entidad Federativa" name="entidad" id="ent_fed2" style="display:none;"> -->
					...
					<div class="botones">
						...
						<div class="botones-nav">
							<form action="1-participacion-empresa.php#01" method="POST" style="display: inline;"> 
								<input type="hidden" name="declaracion" value="<?php echo $tipo_dec ?>">
								<input type="hidden" name="tipo-declaracion" value="I">
								<input type="hidden" name="ejercicio" value="<?php echo $ejercicio ?>">
								<input type="hidden" name="declara_completo" value="<?php echo $_POST['declara_completo'] ?>">
