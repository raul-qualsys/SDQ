...
<script type="text/javascript">
	window.onload = function (){menuopc("06","menu3-1","menu1-2");}
</script>
	<body>
		...
		<div id="main-content">
			...
			$arr=cargarformi6($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
			$html=checkformi6($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
			if(empty($html)){$arr["html"][0]="";}
			else{$arr["html"]=$html;}
			if($arr["total"]==0){
				$arr["secuencia"][0]=1;
				$arr["movimiento"][0]="";
				$arr["tipo_beneficio"][0]="";
				$arr["otro_beneficio"][0]="";
				$arr["beneficiario"][0]="";
			...
			<script type="text/javascript">
		  		$(document).ready(function(){
		    		$('#tipo_beneficio option[value="'+'<?php echo $arr["tipo_beneficio"][0] ?>'+'"]').attr('selected', 'selected');
			...
			<div class="content" id="content">
				...
				<form id="form-content-i">
					<div class="subtitle">6. BENEFICIOS PRIVADOS<br><p class="subtitle2">(HASTA LOS 2 ULTIMOS AÑOS)</p>
					</div>
					...
					<div class="forms-container ningun_registro">
						...
						<div class="form-div-3">
							<label>Tipo de beneficio:</label><span class="asterisk">*</span>
							<select id="tipo_beneficio" name="tipo_beneficio" required>
								<?php lista_valores("Tipo_Beneficio"); ?>
							</select>
						</div>
						<div class="form-div-3" id="div_beneficio" style="display:none;">
							<label>Especifique:</label>
							<input type="text" name="otro_beneficio" id="otro_beneficio" maxlength="100" value="<?php echo $arr['otro_beneficio'][0] ?>">
						</div>
					</div>
					<div class="forms-container ningun_registro">
						<div class="form-div-3">
							<label>Beneficiario:</label><span class="asterisk">*</span>
						...
						<div class="form-div-3" id="div_beneficiario" style="display:none;">
							<label>Especifique:</label>
							<input type="text" name="otro_beneficiario" id="otro_beneficiario" maxlength="100" value="<?php echo $arr['otro_beneficiario'][0] ?>">
						</div>
						<div class="form-div-3">
							<label>Otorgante:</label><span class="asterisk">*</span>
							<select id="otorgante" name="otorgante" required>
					...
					<div class="forms-container ningun_registro">
						<div class="form-div-2-3">
							<label>Nombre o razon social del otorgante:</label><span class="asterisk">*</span>
							<input type="text" placeholder="Nombre del otorgante" name="nombre_otorga" id="nombre_otorga" maxlength="100" value="<?php echo $arr['nombre_otorga'][0] ?>" required>
						</div>
						<div class="form-div-3">
							<label>RFC:</label><span class="asterisk">*</span>
							<input type="text" placeholder="RFC" name="rfc_otorga" id="rfc_otorga" minlength="12" maxlength="13" onkeypress="valida(event,'clave')" onpaste="valida(event,'clave')" value="<?php echo $arr['rfc_otorga'][0] ?>" required>
							<div class="aviso_pendientes" id="aviso_rfc_otorga"></div>
						</div>
					</div>
					<div class="forms-container ningun_registro">
						<div class="form-div-3">
		            		<label>Forma de recepción del beneficio:</label><span class="asterisk">*</span><br>
		            	...
		            	<div class="form-div-3" id="01apoyo" style="display:none;">
		            		<label>Especifique el beneficio:</label><span class="asterisk">*</span>
		            		<input type="text" placeholder="Beneficio" name="beneficio_descr" id="beneficio_descr" maxlength="100" value="<?php echo $arr['beneficio_descr'][0] ?>">
		            	</div>
					</div>
					<div class="forms-container ningun_registro">
						<div class="form-div-3">
							<label>Monto aproximado del beneficio:</label><span class="asterisk">*</span>
							<input type="text" placeholder="Monto del beneficio" name="monto_mensual" id="monto_mensual" onkeypress="valida(event,'int')" onpaste="valida(event,'int')" value="<?php echo $arr['monto_mensual'][0] ?>" required>
						</div>
						<div class="form-div-3">
					...
					<div class="botones">
						...
						<div class="botones-nav">
							...
							<form action="7-fideicomisos.php#07" method="POST" style="display: inline;">
								<input type="hidden" name="declaracion" value="<?php echo $tipo_dec ?>">
								<input type="hidden" name="tipo-declaracion" value="I">
								<input type="hidden" name="ejercicio" value="<?php echo $ejercicio ?>">
								<input type="hidden" name="declara_completo" value="<?php echo $_POST['declara_completo'] ?>">
