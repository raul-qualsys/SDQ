...
<script type="text/javascript">
	window.onload = function (){menuopc("sub3-2p","menu3-1n2","menu1-2n");}
</script>
<body>
	...
	<div id="main-content">
		...
		<div class="content" id="content">
			<div class="title0">
				<div class="title1">Bancos</div>
			</div>
			<div class="forms-container">
				<form method="POST" action="cat-bancos.php">
					<div id="busqueda">
						...
						<div style="display: inline-block;text-align: right;">
							<button id="nuevo_elemento" class="boton-oculto" style="margin:1% 2%;height: auto;" type="button"><img src="<?php echo HTTP_PATH ?>/images/agregarbanco.png" style="height: 40px; width: auto;" title="Agregar banco"></button>
						</div>
					</div>
				</form>
			</div>
			<div class="forms-container">
				<div class="results">
						...
						if(isset($_POST['buscarcat']) || isset($_GET["p"])){
						    ...
						    $query = "SELECT banco_id,descr,descr_larga,estatus FROM qsy_bancos WHERE (descr LIKE '%".$busqueda."%' or banco_id LIKE '%".$busqueda."%') ORDER BY descr";
						    $result=pg_query($conn,$query);
						    $total=pg_num_rows($result);
						    $elementos=10;
						    $paginas=ceil($total/$elementos);
						    $posicion=isset($_GET['p']) ? ($_GET['p']-1)*$elementos : 0;
						    $query = "SELECT banco_id,descr,descr_larga,estatus FROM qsy_bancos WHERE (descr LIKE '%".$busqueda."%' or banco_id LIKE '%".$busqueda."%') ORDER BY descr LIMIT $elementos OFFSET $posicion";
							...
							<table cellspacing="0" cellpadding="0" class="search-table">
						        ...
						        <?php
						            ...
						            $id=$registro["banco_id"];
						            $nombre=$registro["descr"];
						            $nombre_largo=$registro["descr_larga"];
			                        ...
			                        <tr>
			                            ...
			                            <td>
			                                ...
			                                <input type='text' name='nombre_largo' value='<?php echo $nombre_largo ?>' id='nombre_largo<?php echo $key ?>' style='display: none;'>
			                            ...
			                            <td>
						                    <button class="boton-oculto boton-modificar banco-modificar" id="<?php echo $key ?>" type="button"><img src="<?php echo HTTP_PATH ?>/images/editar.png" style="height: 20px;"></button>
			                            </td>
			                        </tr>
			                        <?php
						        }
						        ...
						        <div style="text-align: center;">
							       ...
							       if(isset($_GET["p"]) && $_GET["p"]!=1){
							        	 ?>
							        	<a href="cat-bancos.php?p=<?php echo $_GET['p']-1 ?>&b=<?php echo $busqueda ?>"><button class="seccion-anterior">Anterior</button></a>
							        	<?php 
							        }
						        	for($i=1;$i<=$paginas;$i++){
							        	...
							        	?>
							        	<a href="cat-bancos.php?p=<?php echo $i ?>&b=<?php echo $busqueda ?>" style="text-decoration: none;">
							        ...
							        if((!isset($_GET["p"]) || $_GET["p"]!=$paginas) && $paginas!=1){
							        	 ?>
							        	<a href="cat-bancos.php?p=<?php if(isset($_GET["p"])){echo $_GET['p']+1; }else echo 2;?>&b=<?php echo $busqueda ?>"><button class="seccion-siguiente">Siguiente</button></a>
							        	<?php 
							        }
						        	/* Fin de actualización */
							        ?>
		...
		<div id="nuevo-elemento">
			<div style="text-align: center;"><span>País</span></div>
			<form id="form-nuevo-elemento">
			<table>
				<tr>
					<td class="label-table" style="width: 30%;">Clave de Banco:</td>
					<td style="width: 70%;">
				...
				<tr>
					...
					<td>
						<input type="text" placeholder="Nombre" name="descripcion" id="descripcion" onkeypress="valida(event,'string')" onpaste="valida(event,'string')" maxlength="40" required>
					</td>
				</tr>
				<tr>
					<td class="label-table">Nombre largo:</td>
					<td>
						<input type="text" placeholder="Nombre largo" name="descripcion_larga" id="descripcion_larga" onkeypress="valida(event,'string')" onpaste="valida(event,'string')" maxlength="100" required>
					</td>
				</tr>
				<tr>
			...
			<div style="text-align: center;">				
				...
				<input type="hidden" name="banco" id="validar" value="X">
