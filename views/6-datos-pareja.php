...
<body>
	...
	<div id="main-content">
		...
		$arr=cargarform6($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
		$html=checkform6($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
		...
		<script type="text/javascript">
	  		$(document).ready(function(){
	    		...
	    		$('#relacion_pareja option[value="'+'<?php echo $arr["relacion_pareja"][0] ?>'+'"]').attr('selected', 'selected');
			    ...
			    for (var i = dependiente.length - 1; i >= 0; i--) {
			      if(dependiente[i].value=='<?php echo $arr["dependiente"][0]; ?>'){dependiente[i].checked="checked";}
				}
		...
		<div class="content" id="content">
			...
			<div class="subtitle">6. DATOS DE LA PAREJA</div>
			...
			<div class="forms-container ningun_registro">
				...
				<div class="form-div-3">
					...
					<input type="text" placeholder="RFC" name="rfc_pareja" id="rfc_pareja" minlength="13" maxlength="13" onkeypress="valida(event,'clave')" onpaste="valida(event,'clave')" value="<?php echo $arr['rfc_pareja'][0] ?>" required>
					<div class="aviso_pendientes" id="aviso_rfc_pareja"></div>
				</div>
				<div class="form-div-3">
				...
				<div class="form-div-3">
					<label>¿Es dependiente económico?</label><span class="asterisk">*</span><br>
					<input type="radio" name="dependiente" value="S" checked required>Sí
					<input type="radio" name="dependiente" value="N">No
				</div>
				<div class="form-div-3">
				...
				<div class="form-div-3">
					...
					<select id="relacion_pareja" name="relacion_pareja" required="">
							<?php lista_valores("Relacion_Pareja"); ?>
					</select>
				</div>
				<div class="form-div-3">
			...
			<div class="subsubtitle ningun_registro">
				<label>Domicilio de la pareja:</label>
			</div>
			<div class="forms-container ningun_registro">
					<div class="form-div-3">
