...
<script type="text/javascript">
	window.onload = function (){menuopc("11","menu3-1","menu1-2");}
</script>
<body>
	...
	<div id="main-content">
		...
		$arr=cargarform11($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
		$html=checkform11($tipo_dec,$ejercicio,$_SESSION["rfc"],$conn);
		...
		<div class="content" id="content">
			...
			?>
			<div class="subtitle">11. VEHÍCULOS (SITUACIÓN ACTUAL)</div>
			<?php } else{ ?>
			<div class="subtitle">10. VEHÍCULOS (SITUACIÓN ACTUAL)</div>
			<?php }	?>
			...
			<div class="forms-container ningun_registro">
				<p class="not">Todos los datos de vehículos a nombre de la pareja, dependientes económicos y/o terceros <br>o que sean en copropiedad con el declarante no serán públicos.</p>
				<div class="aviso_pendientes" id="pendientes"><?php echo $arr['html'][0] ?></div>
			<div class="subsubtitle">Vehículos del declarante, pareja y/o dependientes económicos</div>
			</div>
			...
			<div class="forms-container ningun_registro">
				<div class="form-div-3">
					<label>Tipo de vehículo:</label><span class="asterisk">*</span>
				...
				<div style="display: none;" class="form-div-3" id="otro-ambito">
					<label>Especifique:</label>
					<input type="text" class="otro-regimen opcion-otro" name="otro_vehiculo" id="otro_vehiculo" maxlength="50" value="<?php echo $arr['otro_vehiculo'][0] ?>">
				</div>
				<div class="form-div-2">
					<label>Titular del vehículo:</label><span class="asterisk">*</span>
			...
			<div class="forms-container ningun_registro">
				<div class="form-div-3">
					...
					<input type="text" name="marca" id="marca" placeholder="Marca" maxlength="30" value="<?php echo $arr['marca'][0] ?>" required>
				</div>
				<div class="form-div-3">
					<label>Modelo:</label><span class="asterisk">*</span>
					<input type="text" name="modelo" id="modelo" placeholder="Modelo" maxlength="30" value="<?php echo $arr['modelo'][0] ?>" required>
				</div>
				<div class="form-div-3">
					<label>Año:</label><span class="asterisk">*</span>
					<input type="text" name="anio" id="anio" placeholder="Año" onkeypress="valida(event,'int')" onpaste="valida(event,'int')" min="0" max="<?php echo date('Y')+1; ?>" value="<?php echo $arr['anio'][0] ?>" required>
				</div>
				<div class="form-div-3">
					<label>Número de serie o registro:</label><span class="asterisk">*</span>
					<input type="text" name="serie" id="serie" placeholder="No. de serie" maxlength="30" value="<?php echo $arr['serie'][0] ?>" required>
				</div>
				<div class="form-div-3">
					<label>Lugar de registro:</label><span class="asterisk">*</span><br>
					<input type="radio" name="ubicacion" id="01mexico" value="M" checked required>MÉXICO
					<input type="radio" name="ubicacion" id="01extranjero" value="E">EXTRANJERO
				</div>
				<div class="form-div-3">
			...
			<div class="forms-container ningun_registro">
				...
				<div class="form-div-3">
					<label>Fecha de adquisición del vehículo:</label><span class="asterisk">*</span>
